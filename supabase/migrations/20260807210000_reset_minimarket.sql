-- ==============================================================================
-- MIGRACIÓN DE REINICIO TOTAL Y PURGA DE DATOS OBSOLETOS
-- Garantiza que Supabase ejecute esta migración y limpie cualquier dato antiguo de cafetería.
-- ==============================================================================

-- 1. PURGA Y RESTRUCTURACIÓN DE TABLAS
...
-- 5. INVENTARIO PARA LOS PRODUCTOS
